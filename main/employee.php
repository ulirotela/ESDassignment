...
<?php 
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM employee ORDER BY id DESC");
				$result->execute();
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><a  title="Click To Edit Customer" rel="facebox" href="editemployee.php?id=<?php echo $row['id']; ?>"><button class="btn btn-warning btn-mini"><i class="icon-edit"></i> Edit </button></a> 
