...
<?php include('navfixed.php');?>
	...
	<div class="contentheader">
			...
			<font style=" font:bold 25px 'Aleo'; color:#049bd;"><center>Uli & Wine Co </center></font>
<div id="mainmain">
	<?php
...
?>
<a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"><i class="icon-shopping-cart icon-2x"></i><br> Sales</a>               
<a href="supplies.php"><i class="icon-list-alt icon-2x"></i><br> Supplies</a>     
...
<a href="employee.php"><i class="icon-flag icon-2x"></i><br> Employee</a>
<?php 
    }                   
    ?>
