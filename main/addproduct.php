...
<span>Varietal : </span><input type="text" style="width:265px; height:30px;" name="varietal" Required/><br>
<span>Vintage : </span><input type="text" style="width:265px; height:30px;" name="vintage" Required/><br>
<span>Description : </span><input type="text" style="width:265px; height:30px;" name="description" Required/><br>
	
</select><br>
<span>Storehouse Arrival: </span><input type="date" style="width:265px; height:30px;" placeholder="09/13/2017" class="tcal tcalInput"  name="date_arrival" ></input><br>
<span>Harvest Date: </span><input type="date" style="width:265px; height:30px;" placeholder="09/13/2017" class="tcal tcalInput" name="exdate" ></input><br>
<span>Selling Price: </span><input type="text" id="txt1" style="width:265px; height:30px;" name="price" onkeyup="sum();" Required><br>
<span>Production Cost: </span><input type="text" id="txt2" style="width:265px; height:30px;" name="o_price" onkeyup="sum();" Required><br>
