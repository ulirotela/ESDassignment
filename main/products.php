...
<a rel="facebox" href="addproduct.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Products</button></a><br><br>
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			<th width="12%"> Item Code </th>
			<th width="14%"> Item Name </th>
			<th width="7%"> Varietal </th>
			<th width="7%"> Vintage </th>
			<th width="7%"> Description </th>
			<th width="9%"> Date at Storehouse </th>
			<th width="10%"> Harvest Date </th>
			<th width="6%"> Cost Of Production </th>
			<th width="6%"> Price per Bottle </th>
			<th width="6%"> QTY </th>
